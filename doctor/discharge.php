    ...
    <div class="container-fluid">
     <div class="col-md-12">
         <div class="row">
            ...
            <div class="col-md-10">
                <h2 class="text-center my-4">Total Appointment</h2>
                <?php
                        ...
                        <div class="row">
                            ...
                            if(isset($_POST['send']))
                            {
                                ...
                                else
                                {
                                    $doc=$_SESSION['doctor'];
                                    $fname=$row['firstname'];
                                    $query="INSERT INTO `income`(doctor,patient,date_discharge,amount_paid,description) VALUES
                            ...
                            ?>
                                ...
                                <form method="post" class="jumbotron">
                                   ...
                                   autocomplete="off" placeholder="Enter patient fee">

                                   <label>Description</label>
                                   <input type="text" name="des" class="form-control"
                                   autocomplete="off" placeholder="Enter Description">

                                   <input type="submit" class="btn btn-info my-2" class="form-control"
