        ...
        <div class="container-fluid">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <h2 class="text-center">Edit Doctors</h2>
                        <hr>
                         <?php
                         if(isset($_GET['id']))
                         {
                         ...
                         <div class="row">
                             <div class="col-md-8">
                                 ...
                                 <h5 class="my-3">Phone : +91<?php echo  $row['phone'];?></h5>
                        ...
                        ?>         
                                 <form method="post">
                                     ...
                                     autocomplete="off" palceholder="Enter Doctor's Salary"
